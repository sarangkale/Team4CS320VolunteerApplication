      ...
      <div className="max-w-[900px] mx-auto mt-8 px-6 pb-12">
       ...
       <div className="flex items-center justify-between mb-4">
        <div className="bg-[#D9D9D9] rounded-full p-1 inline-flex gap-1">
          ...
          {/* Volunteers tab */}
          <button
            onClick={() => navigate(`/organization_dashboard/view_applicant/${eventId}`)}
          ...
          {/* Edit Info tab (active) */}
          <button
            className="px-7 py-2 rounded-full text-[16px] border-none cursor-pointer font-['DM_Sans',sans-serif] transition-all duration-200 bg-white shadow-md font-medium text-[#1a1a1a]"
          >
            Edit Information
          </button>
