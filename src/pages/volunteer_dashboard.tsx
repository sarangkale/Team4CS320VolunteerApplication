...
export default function VolunteerDashboard() {
    ...
    const [overlay, setOverlay] = useState<"profile" | "events" | null>(null);
    ...
    const handleFormChange = (e: React.ChangeEvent<HTMLTextAreaElement | HTMLInputElement, HTMLTextAreaElement | HTMLInputElement>) => {
